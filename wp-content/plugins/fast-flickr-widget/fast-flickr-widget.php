...
class FastFlickrWidget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			'Fast Flickr Widget', // Name
			array( 'description' => __( 'Flickr Images', 'text_domain' ), ) // Args
		);
	...
	public function form( $instance ) {
		...
		<p><label for="<?php echo $this->get_field_id( 'view' ); ?>"><?php _e("Thumbnail, square or medium?"); ?>
		...
		<p><label for="<?php echo $this->get_field_id( 'before_item' ); ?>"><?php _e("Before item:"); ?> <input class="widefat" id="<?php echo $this->get_field_id( 'before_item' ); ?>" name="<?php echo $this->get_field_name( 'before_item' ); ?>" type="text" value="<?php echo esc_attr($before_item); ?>" /></label></p>
		<p><label for="<?php echo $this->get_field_id( 'after_item' ); ?>"><?php _e("After item:"); ?> <input class="widefat" id="<?php echo $this->get_field_id( 'after_item' ); ?>" name="<?php echo $this->get_field_name( 'after_item' ); ?>" type="text" value="<?php echo esc_attr($after_item); ?>" /></label></p>
		<p><label for="<?php echo $this->get_field_id( 'before_widget' ); ?>"><?php _e("Before widget:"); ?> <input class="widefat" id="<?php echo $this->get_field_id( 'before_widget' ); ?>" name="<?php echo $this->get_field_name( 'before_widget' ); ?>" type="text" value="<?php echo esc_attr($before_flickr_widget); ?>" /></label></p>
		<p><label for="<?php echo $this->get_field_id( 'after_widget' ); ?>"><?php _e("After widget:"); ?> <input class="widefat" id="<?php echo $this->get_field_id( 'after_widget' ); ?>" name="<?php echo $this->get_field_name( 'after_widget' ); ?>" type="text" value="<?php echo esc_attr($after_flickr_widget); ?>" /></label></p>
		...
		<p><label for="<?php echo $this->get_field_id( 'more_title' ); ?>"><?php _e("More link anchor text:"); ?> <input class="widefat" id="<?php echo $this->get_field_id( 'more_title' ); ?>" name="<?php echo $this->get_field_name( 'more_title' ); ?>" type="text" value="<?php echo esc_attr($more_title); ?>" /></label></p>
		<p><label for="<?php echo $this->get_field_id( 'tags' ); ?>"><?php _e("Filter by tags (comma seperated):"); ?> <input class="widefat" id="<?php echo $this->get_field_id( 'tags' ); ?>" name="<?php echo $this->get_field_name( 'tags' ); ?>" type="text" value="<?php echo esc_attr($tags); ?>" /></label></p>
		<p><label for="<?php echo $this->get_field_id( 'target' ); ?>"><input id="<?php echo $this->get_field_id( 'target' ); ?>" name="<?php echo $this->get_field_name( 'target' ); ?>" type="checkbox" value="checked" <?php echo $target; ?> /> <?php _e("Target: _blank"); ?></label></p>
		<p><label for="<?php echo $this->get_field_id( 'show_titles' ); ?>"><input id="<?php echo $this->get_field_id( 'show_titles' ); ?>" name="<?php echo $this->get_field_name( 'show_titles' ); ?>" type="checkbox" value="checked" <?php echo $show_titles; ?> /> <?php _e("Display titles"); ?></label></p>
		<p><label for="<?php echo $this->get_field_id( 'thickbox' ); ?>"><input id="<?php echo $this->get_field_id( 'thickbox' ); ?>" name="<?php echo $this->get_field_name( 'thickbox' ); ?>" type="checkbox" value="checked" <?php echo $thickbox; ?> /> <?php _e("Use Thickbox"); ?></label></p>
		<p><label for="<?php echo $this->get_field_id( 'random' ); ?>"><input id="<?php echo $this->get_field_id( 'random' ); ?>" name="<?php echo $this->get_field_name( 'random' ); ?>" type="checkbox" value="checked" <?php echo $random; ?> /> <?php _e("Random pick"); ?></label></p>
		<p><label for="<?php echo $this->get_field_id( 'random_tag' ); ?>"><input id="<?php echo $this->get_field_id( 'random_tag' ); ?>" name="<?php echo $this->get_field_name( 'random_tag' ); ?>" type="checkbox" value="checked" <?php echo $randomTag; ?> /> <?php _e("Use random tag (needs random pick enable)"); ?></label></p>
			...
			if (!$javascript) {
						...
						if ($photos)
						{
							...
							foreach($photos["items"] as $key => $value)
							{
								...
								$out .= $before_item . "<a $thickbox_attrib $target href=\"$href\"><img vspace=\"2\" hspace=\"5\" class=\"flickr_photo\" alt=\"$photo_description\" title=\"$photo_description\" src=\"$photo_url\" /></a>$photo_title" . $after_item;
							}
							if($randomTagText != "") { 
